# All code for baseline algorithms was taken from https://github.com/rn5l/session-rec
...
class VMContextKNN:
    ...
    def __init__(self, k, sample_size=1000, sampling='recent', similarity='vec', weighting='div', dwelling_time=False,
                 last_n_days=None, last_n_clicks=None, remind=True, push_reminders=False, add_reminders=False,
                 extend=False, weighting_score='div', weighting_time=False, normalize=True, idf_weighting=False,
                 idf_weighting_session=False, session_key='SessionId', item_key='ItemId', time_key='Time'):
