...
class GatedCNN(nn.Module):
    ...
    def __init__(self,
        ...
        self.k_pool = k_pool
        self.padding_0 = nn.ConstantPad2d((0, 0, kernel_size - 1, 0),
                                          0)  # not using future songs to predict current songs
        ...
        self.paddings = nn.ModuleList([nn.ConstantPad1d((kernel[0] - 1, 0), 0) for _ in
                                       range(n_layers)])  # not using future songs to predict current songs
